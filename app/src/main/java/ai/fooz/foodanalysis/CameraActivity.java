    ...
    public void showUnknownClassPopup() {
        ...
        dialogBuilder.setPositiveButton("Send", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if(editV.length() > 0){
                    String mailto = "mailto:17IT41@QUEST.EDU.PK";
    ...
    public void setupItemValues(List<Prediction> results) {
        ...
        if (existingImg != null) {
            for (int i=0; i<results.size(); i++) {
                ...
                Prediction val = results.get(i);
                if (val.isSelected) {
                    if (val.title.equals("Apple")) {
                        itemCals.setText(String.valueOf("300"));
                        itemCarbs.setText("150 gms");
                        itemFats.setText("100 gms");
                        itemProts.setText("130 gms");
                    }
                 /*   Toast.makeText(getApplicationContext()," "+val.title,Toast.LENGTH_LONG).show();
                   ...
                   // itemProts.setText(String.valueOf(val.proteins)+" gms");
                    if(val.carbs<=60){
                   // Toast.makeText(getApplicationContext(),"it is safe & healthy for The Diabetic Patients! "+val.carbs,Toast.LENGTH_SHORT).show();
                        AlertDialog.Builder builder = new AlertDialog.Builder(this);
                        builder.setCancelable(true);
                        builder.setTitle("Information!");
                        builder.setIcon(R.drawable.informaton);
                        builder.setMessage("It is safe & healthy for The Diabetic Patients!");
                    ...
                    else if(val.carbs >=61 && val.carbs<=100) {
                       // Toast.makeText(getApplicationContext(),"It can be harmfull for Diabetic Patients,Warning! "+ val.carbs,Toast.LENGTH_SHORT).show();

                        AlertDialog.Builder builder = new AlertDialog.Builder(this);
                        builder.setCancelable(true);
                        builder.setTitle("Warning!");
                        builder.setIcon(R.drawable.warning);
                        builder.setMessage("It can be harmfull for Diabetic Patients!");
                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                    ...
                    else if(val.carbs>=101) {
                       // Toast.makeText(getApplicationContext()," It very harmfull for Diabetic Patients,Dangerous! "+val.carbs,Toast.LENGTH_SHORT).show();

                        AlertDialog.Builder builder = new AlertDialog.Builder(this);
                        builder.setCancelable(true);
                        builder.setTitle("Dangerous!");
                        builder.setIcon(R.drawable.dangerous);
                        builder.setMessage("It is very harmfull for Diabetic Patients!");
                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
        ...
        //    itemFats.setText(String.valueOf(MyUtility.getRandomNumber(5, 60))+" gms");
          ...
          //  Toast.makeText(getApplicationContext(),itemCarbs.getText()+" for patient",Toast.LENGTH_SHORT).show();
        }
    }
}
